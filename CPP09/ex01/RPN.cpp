...
void    RPN::checkAndCalculate(std::string expression)
{
    ...
    for (size_t i = 0; i < length; ++i)
    {
        if (!(expression[i] >= '0' && expression[i] <= '9') && !(expression[i] == '+' ||
            ...
            {
                std::cout<<"\33[1;31mError: not valid symbols!\33[1;31m"<<std::endl;
                return ;
            }
    }
    for (size_t i = 0; i < length; ++i)
    {
        ...
        else
        {
            ...
            {
                std::cout<<"\33[1;31mError: not valid postfix notation!\33[1;31m"<<std::endl;
            ...
            else if (expression[i] == '/')
            {
                ...
                {
                    std::cout<<"\33[1;31mError: Division by zero is forbidden!\33[1;31m"<<std::endl;
                    while (this->_stack.empty() == 0)
                    {
                        this->_stack.pop();
                    }
