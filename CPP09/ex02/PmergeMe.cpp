...
PmergeMe::PmergeMe(const std::string& numSequence)
{
    ...
    {
        throw std::runtime_error("\33[1;31mError!\33[1;31m");
    }
...
void    PmergeMe::checkVectorSort(void)
{
    if (_vector.empty())
    {
        std::cout<<"\33[1;31mThe vector is empty!\33[1;31m"<<std::endl;
        return ;
    }
    ...
    for (std::vector<int>::const_iterator it = _vector.begin(); it != _vector.end(); ++it)
    {
        ...
        if (comparisonIt != _vector.end())
        {
            if (*it > *comparisonIt)
            {
                std::cout<<"\33[1;31mError: The vector is not sorted!\33[1;31m"<<std::endl;
                return ;
            }
        }
    }
    std::cout<<"\33[1;32mThe vector is succesfully sorted!\33[1;32m"<<std::endl;
}
...
void    PmergeMe::checkListSort(void)
{
    if (_list.empty())
    {
        std::cout<<"\33[1;31mThe list is empty!\33[1;31m"<<std::endl;
        return ;
    }
    ...
    for (std::list<int>::const_iterator it = _list.begin(); it != _list.end(); ++it)
    {
        ...
        if (comparisonIt != _list.end())
        {
            if (*it > *comparisonIt)
            {
                std::cout<<"\33[1;31mError: The list is not sorted!\33[1;31m"<<std::endl;
                return ;
            }
        }
    }
    std::cout<<"\33[1;32mThe list is succesfully sorted!\33[1;32m"<<std::endl;
}
