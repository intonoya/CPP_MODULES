...
void ft_print(int i, float f, double d, int flag)
{
	if (i >= 0 && i <= 127)
	{
		if (isprint(i) == 0)
...
static bool	for_char(const std::string &str)
{
	int		i;
	float	f;
	double	d;
...
static bool	for_int(const std::string &str)
{
	int		my_int;
	int		i;
	float	f;
...
static bool	for_double(const std::string &str)
{
	double	my_double;
	int		flag = 0;
	int		i;
...
static bool	for_float(const std::string &str)
{
	double	my_float;
	int		flag = 0;
	int		i;
...
{
	if (for_char(str) == true)
		return (true);
	else if (for_int(str) == true)
		return (true);
	else if (for_double(str) == true)
		return (true);
	else if (for_float(str) == true)
		return (true);
	return (false);
}